            ...
            <div class="w-full lg:w-2/5">
                <form action="{{ route('cotizaciones.store') }}" method="POST">
                    ...
                    <div class="flex flex-row items-center justify-between px-5 mt-5">
                        <div class="font-bold text-xl">Cotización</div>
                        <div class="font-semibold">
                            <a type="button" href="{{ route('cotizaciones.create') }}" class="px-4 py-2 rounded-md bg-red-100 text-red-500 hover:bg-red-500 hover:text-white cursor-pointer transition duration-300">
                                Cancelar
                            </a>
                        </div>
                    </div>
